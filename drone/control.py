...
class ControlDrone:
    ...
    def __init__(self, drone):
        ...
        self.controls = {
            'w': 'forward',
            's': 'backward',
            'left': lambda drone, speed: move_right(drone, speed),
            'right': lambda drone, speed: move_left(drone, speed),
            'o': lambda drone, speed: drone.takeoff(),
            'p': lambda drone, speed: drone.land(),
        }
        self.speed = 10
...
"""
Aquí se aplica zoom a la imagen cuando se toma video (grabando)
"""
...
"""
Diccionario de lista de controles por movimiento

En teoría, aquí debo definir el status para poderlo controlar
"""
controls = {
    'w': 'forward',
    's': 'backward',
